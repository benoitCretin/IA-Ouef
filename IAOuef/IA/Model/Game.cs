...
namespace IA.Model
{
    public class Game
    {
        ...
        public void UpdatePlayers()
        {
            ...
            this.players[0].Score = Convert.ToInt32(player1[0]);
            this.players[0].Attack = Convert.ToInt32(player1[1]);
            this.players[0].Hp = Convert.ToInt32(player1[2]);
            this.players[0].Activity = player1[3];
            this.players[0].ChestNumber = Convert.ToInt32(player1[4]);
            this.players[0].LootValue = Convert.ToInt32(player1[5]);

            this.players[1].Score = Convert.ToInt32(player2[0]);
            this.players[1].Attack = Convert.ToInt32(player2[1]);
            this.players[1].Hp = Convert.ToInt32(player2[2]);
            this.players[1].Activity = player2[3];
            this.players[1].ChestNumber = Convert.ToInt32(player2[4]);
            this.players[1].LootValue = Convert.ToInt32(player2[5]);

            this.players[2].Score = Convert.ToInt32(player3[0]);
            this.players[2].Attack = Convert.ToInt32(player3[1]);
            this.players[2].Hp = Convert.ToInt32(player3[2]);
            this.players[2].Activity = player3[3];
            this.players[2].ChestNumber = Convert.ToInt32(player3[4]);
            this.players[2].LootValue = Convert.ToInt32(player3[5]);

            this.players[3].Score = Convert.ToInt32(player4[0]);
            this.players[3].Attack = Convert.ToInt32(player4[1]);
            this.players[3].Hp = Convert.ToInt32(player4[2]);
            this.players[3].Activity = player4[3];
            this.players[3].ChestNumber = Convert.ToInt32(player4[4]);
            this.players[3].LootValue = Convert.ToInt32(player4[5]);
        }
